...
import ShowcaseNavbar from "@/components/showcase-navbar"; "@/components/showcase-navbar";
          ...
          {[
                {
                  ...
                  description:
                    "Turn your aspirations into reality with our Counselling services.",
                },

                {
                  title: "One to One Consultation",
                  description:
                    "Get expert advice on how to improve your career selection.",
                },
                {
                  title: "Technical Support",
                  description:
                    "Get technical support for your application.",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
